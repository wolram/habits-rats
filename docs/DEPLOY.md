...
server {
    listen 80;
    server_name habitsrats.app www.habitsrats.app;
    root /var/www/habitsrats.app;
    index index.html;
...
<script
  async
  src="https://www.googletagmanager.com/gtag/js?id=G-SEU_ID_AQUI"
></script>
```
...
- Apontар DNS para: `habitsrats.app`
...
- [ ] Verificar sitemap.xml: https://habitsrats.app/sitemap.xml
- [ ] Verificar robots.txt: https://habitsrats.app/robots.txt
...
_Deploy em: 5 de janeiro de 2026_
