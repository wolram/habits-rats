					...
					context.report({
						...
						suggest: option.suggest ? [{
							fix(fixer) {
								...
								return fixer.replaceTextRange(nameWithLoc.range, `${sourceCode.text[nameWithLoc.range[0]]}${JSON.stringify(option.suggest).slice(1, -1).replace(/'/gu, String.raw`\'`)}${sourceCode.text[nameWithLoc.range[1] - 1]}`);
							},
							messageId: "instead",
