		...
		create(context) {
			...
			*/
			function checkProgramForMaxLength(node) {
				...
				if (scriptTokens.length > 0) scriptLinesRange = scriptComments.length > 0 ? [Math.min(scriptTokens[0].loc.start.line, scriptComments[0].loc.start.line), Math.max(scriptTokens[scriptTokens.length - 1].loc.end.line, scriptComments[scriptComments.length - 1].loc.end.line)] : [scriptTokens[0].loc.start.line, scriptTokens[scriptTokens.length - 1].loc.end.line];
				else if (scriptComments.length > 0) scriptLinesRange = [scriptComments[0].loc.start.line, scriptComments[scriptComments.length - 1].loc.end.line];
