...
var require_regexp = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	*/
	function escape(string) {
		return string && RE_HAS_REGEXP_CHAR.test(string) ? string.replace(RE_REGEXP_CHAR, String.raw`\$&`) : string;
	}
	/**
	...
	*/
	function toRegExp(string, flags = {}) {
		...
		if (parts) return new RegExp(parts[1], parts[2].replace(new RegExp(`[${forceAddFlags}${forceRemoveFlags}]`, "g"), "") + forceAddFlags);
